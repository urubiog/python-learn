...
class Heap:
    ...
    def _heapify_down(self, index: int) -> None:
        ...
        while True:
            ...
            if left < size and ((self.is_min_heap and self.heap[left] < self.heap[smallest_or_largest]) or 
                                (not self.is_min_heap and self.heap[left] > self.heap[smallest_or_largest])):
                smallest_or_largest = left
            if right < size and ((self.is_min_heap and self.heap[right] < self.heap[smallest_or_largest]) or 
                                 (not self.is_min_heap and self.heap[right] > self.heap[smallest_or_largest])):

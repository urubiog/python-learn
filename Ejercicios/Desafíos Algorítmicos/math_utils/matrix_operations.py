...
def sumar_matrices(matriz_a: list[list[float]], matriz_b: list[list[float]]) -> list[list[float]]:
    """
...
def restar_matrices(matriz_a: list[list[float]], matriz_b: list[list[float]]) -> list[list[float]]:
    """
...
def multiplicar_por_escalar(matriz: list[list[float]], escalar: float) -> list[list[float]]:
    """
...
def multiplicar_matriz_por_vector(matriz: list[list[float]], vector: list[float]) -> list[float]:
    """
...
def resolver_sistema_gauss(matriz: list[list[float]], resultados: list[float]) -> list[float]:
    """

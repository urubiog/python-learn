...
def programacion_entera_lineal(
    c: list[int], A: list[list[int]], b: list[int], n: int, m: int
) -> list[int]:
    """
...
def corte_de_barras(
    longitudes: list[int], ganancias: list[int], longitud_maxima: int, n: int
) -> int:
    """
...
def mochila_multidimensional(
    capacidades: list[int], pesos: list[list[int]], valores: list[list[int]], n: int
) -> int:
    """

...
def resolver_laberinto(maze: list[list[int]], start: tuple[int, int], end: tuple[int, int]) -> list[tuple[int, int]]:
    """
...
def resolver_crucigrama(tablero: list[list[str]], palabras: list[str]) -> list[list[str]]:
    """
...
def caminos_en_grafo(grafo: dict[int, list[int]], inicio: int, fin: int) -> list[list[int]]:
    """

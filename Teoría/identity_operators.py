...
a = 10
b = 10
result_is = a is b  # True -> Both variables point to the same object (small integers are cached in Python)

# Using "is not"
x = [1, 2, 3]
y = [1, 2, 3]
result_is_not = x is not y  # True -> Lists with the same values are stored in different memory locations
